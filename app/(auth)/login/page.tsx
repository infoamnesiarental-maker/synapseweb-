...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#000000] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#A855F7]/5 via-transparent to-[#3B82F6]/5 pointer-events-none"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-bold text-white mb-3 uppercase tracking-wide">Iniciar Sesión</h2>
          <p className="text-white/70 text-lg">Accede a tu cuenta para continuar</p>
        </div>
